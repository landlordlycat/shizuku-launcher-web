  ...
  return (
    <div className="App">
      ...
      {isLaunchingInstance ? (<CircularProgress sx={{ m: 1 }} />) : (
        <div>
          <FormControl>
            <Button sx={{ m: 1 }} variant="contained" size="small" onClick={launchInstance}>执行</Button>
          </FormControl>
        </div>)}
      <Divider sx={{ m: 1 }} />
      ...
      {isGettingQuota ? (<CircularProgress sx={{ m: 1 }} />) : (
        <div>
          <FormControl>
            <Button sx={{ m: 1 }} variant="contained" size="small" onClick={getQuota}>执行</Button>
          </FormControl>
        </div>
      )}
      <Divider sx={{ m: 1 }} />
      ...
      {isCheckingInstances ? (<CircularProgress sx={{ m: 1 }} />) : (
        <div>
          <FormControl>
            <Button sx={{ m: 1 }} variant="contained" size="small" onClick={checkInstances}>执行</Button>
          </FormControl>
        </div>
      )}
      {isCheckedInstances ? (
